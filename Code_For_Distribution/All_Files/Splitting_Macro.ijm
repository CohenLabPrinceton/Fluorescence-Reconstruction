...
n - (integer) the number indicating patch divisions per side of the input image. 
...
var_name - (string) the name of the output variable. This is used for naming the output patches. 
